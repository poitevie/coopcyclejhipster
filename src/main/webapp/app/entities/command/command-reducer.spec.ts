...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './command.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COMMAND_LIST actions', async () => {
    ...
    it('dispatches FETCH_COMMAND actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COMMAND actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COMMAND actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COMMAND actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COMMAND actions', async () => {
      const expectedActions = [
        {
