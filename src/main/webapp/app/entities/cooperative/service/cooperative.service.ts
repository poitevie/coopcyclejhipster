...
export class CooperativeService {
  ...
  update(cooperative: ICooperative): Observable<EntityResponseType> {
    return this.http.put<ICooperative>(`${this.resourceUrl}/${getCooperativeIdentifier(cooperative) as string}`, cooperative, {
      observe: 'response',
    });
  }

  partialUpdate(cooperative: ICooperative): Observable<EntityResponseType> {
    return this.http.patch<ICooperative>(`${this.resourceUrl}/${getCooperativeIdentifier(cooperative) as string}`, cooperative, {
      observe: 'response',
    });
  }
