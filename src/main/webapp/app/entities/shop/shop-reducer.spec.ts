...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './shop.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SHOP_LIST actions', async () => {
    ...
    it('dispatches FETCH_SHOP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SHOP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SHOP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SHOP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SHOP actions', async () => {
      const expectedActions = [
        {
