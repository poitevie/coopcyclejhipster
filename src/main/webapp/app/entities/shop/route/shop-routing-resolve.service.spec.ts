...
describe('Shop routing resolve service', () => {
  ...
  let resultShop: IShop | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return new IShop if id is not provided', () => {
      // GIVEN
      ...
      expect(resultShop).toEqual(new Shop());
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse({ body: null as unknown as Shop })));
      mockActivatedRouteSnapshot.params = { id: 123 };
