...
class ClientResourceIT {
    ...
    private static final String DEFAULT_EMAIL_C = "AAAAAAAAAA";
    private static final String UPDATED_EMAIL_C = "BBBBBBBBBB";
    ...
    void partialUpdateClientWithPatch() throws Exception {
        ...
        partialUpdatedClient.lastnameC(UPDATED_LASTNAME_C).emailC(UPDATED_EMAIL_C).phoneC(UPDATED_PHONE_C);
