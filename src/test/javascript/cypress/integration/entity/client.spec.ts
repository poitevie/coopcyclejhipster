...
describe('Client e2e test', () => {
  ...
  const clientSample = { idC: 'Rustic', firstnameC: 'Ujaq', lastnameC: 'Qmh', emailC: 'rny3d@3i3-\\)re', addressC: 'Handmade Garden' };
  ...
  describe('new Client page', () => {
    ...
    it('should create an instance of Client', () => {
      ...
      cy.get(`[data-cy="emailC"]`).type('_au@xz6o\fhfgb').should('have.value', '_au@xz6o\fhfgb');

      cy.get(`[data-cy="phoneC"]`).type('core Gloves').should('have.value', 'core Gloves');

      cy.get(`[data-cy="addressC"]`).type('Planner Bedfordshire').should('have.value', 'Planner Bedfordshire');
